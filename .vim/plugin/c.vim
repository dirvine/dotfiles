...
if	s:MSWIN
	...
	let s:C_CCompiler           = 'clang'      " the C   compiler
	let s:C_CplusCompiler       = 'clang++'      " the C++ compiler
...
"
let s:C_CplusCFlags         	= '-Wall -g -O0 -c -stdlib=libc++ -std=c++11'      " C++ compiler flags: compile, don't optimize
let s:C_CplusLFlags         	= '-Wall -g -O0 -stdlib=libc++ -std=c++11'         " C++ compiler flags: link   , don't optimize
let s:C_CplusLibs           	= '-lm -ldl'                  " C++ libraries to use
"
