...
beautiful.init("/home/dirvine/.config/awesome/themes/default/theme.lua")
...
globalkeys = awful.util.table.join(
     ...
     local cmenu = awful.menu.clients({width=245}, { keygrabber=true })end),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "o",      function (c) awful.client.movetoscreen(c, -1) end ),
